...
import { useDeleteMenuItemMutation } from '../services/menuApi';
...
export function DeleteMenuModal({ isOpen, item, onClose }: DeleteMenuModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-md p-4 animate-in fade-in duration-200">
      ...
      >
        ...
        <p className="text-xs text-slate-400 max-w-xs mx-auto mb-6">
          Are you sure you want to delete <strong className="text-amber-400">&quot;{item.name}&quot;</strong>? This action cannot be undone and will remove associated Cloudinary image assets.
        </p>
